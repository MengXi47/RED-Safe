...
EdgeApplication::EdgeApplication(boost::asio::io_context& io_context,
...
int EdgeApplication::Run() {
    LogInfoFormat("啟動 RED_SAFE_EDGE_CORE，edge_id={} version={} mqtt_broker={} grpc_port={}",
                  config_.edge_id, config_.version, config_.mqtt_broker, config_.grpc_port);
    ...
    auto workflow = std::make_shared<MqttWorkflow>(mqtt_client_, config_, scan_executor_);
    boost::asio::co_spawn(
        io_context_,
