...
std::string CreateAccessToken::getAccessToken() const { return token; }

std::string CreateAccessToken::getErrorMessage() const { return errorMessage; }
...
std::string DecodeAccessToken::getUserId() const { return payloadUserId; }

std::string DecodeAccessToken::getErrorMessage() const { return errorMessage; }
...
std::string CreateRefreshToken::getRefreshToken() const { return token; }

std::string CreateRefreshToken::getErrorMessage() const { return errorMessage; }
...
util::Result RevokeRefreshToken::run(const std::string& refreshtoken) {
  ...
  return util::Result{util::status_code::Success, util::error_code::Success, json{}};
}
}  // namespace redsafe::apiserver::service::token
