...
util::Result signup::run(const std::string &email, const std::string &user_name,
  ...
  if (!is_vaild_password(password))
    return util::Result{util::status_code::BadRequest,
                        util::error_code::Invalid_password_format, json{}};
  ...
  if (const auto e = UserRegistrar::start(email, user_name, password_hash);
    ...
    return util::Result{util::status_code::Conflict,
                        util::error_code::Email_already_registered, json{}};
  else if (e == 2)
    return util::Result{util::status_code::InternalServerError,
                        util::error_code::Internal_server_error, json{}};
...
util::Result Binding::bind(const std::string &serial_number,
  ...
  token::DecodeAccessToken decode(access_token);
  {
    ...
    if (code == 1)
      return util::Result{util::status_code::BadRequest,
                          util::error_code::Access_Token_expired, json{}};
    if (code == 2)
      return util::Result{util::status_code::BadRequest,
                          util::error_code::Access_Token_invalid, json{}};
    if (code == 3)
      return util::Result{util::status_code::BadRequest,
                          util::error_code::JWT_invalid_signature, json{}};
    if (code == 4)
      return util::Result{util::status_code::BadRequest,
                          util::error_code::JWT_invalid_token_supplied, json{}};
    if (code == 5)
      return util::Result{util::status_code::InternalServerError,
                          util::error_code::Internal_server_error, json{}};
  }
  ...
  if (const auto a =
      ...
      a == 1)
    return util::Result{util::status_code::Conflict,
                        util::error_code::Binding_already_exists, json{}};
  else if (a == 2)
    return util::Result{util::status_code::InternalServerError,
                        util::error_code::Internal_server_error, json{}};
...
util::Result Binding::unbind(const std::string &serial_number,
                             const std::string &access_token) {
  token::DecodeAccessToken decode(access_token);
  {
    const auto code = decode.start();
